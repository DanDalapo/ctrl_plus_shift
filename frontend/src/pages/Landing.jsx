      ...
      <div className="landing-container">
        ...
        <div className="landing-cards-container">
          ...
          <div className="landing-card candidate-card">
            ...
            {/* Candidate continues to Register (as they likely need to set up a profile) */}
            <Link to="/register" className="card-button candidate-button">
          ...
          <div className="landing-card voter-card">
            ...
            <Link to="/home" className="card-button voter-button">
              Continue as Voter
            </Link>
          </div>
